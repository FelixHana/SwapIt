...
public enum OrderCodeEnum implements BaseCodeEnum {
    ...
    REVIEW_EXIST(HttpStatus.OK, 20003, "评价已存在"),
    REVIEW_NOT_EXIST(HttpStatus.OK, 20004, "评价不存在"),
    ORDER_TOKEN_ERROR(HttpStatus.OK, 20005, "订单token错误"),
    ORDER_PAY_AMOUNT_ERROR(HttpStatus.OK, 20006, "支付金额错误"),
    ...
    ORDER_SERVICE_EXCEPTION(HttpStatus.OK, 29999, "其他异常 (测试)");
